...
Scikit-learn. (n.d.). *Model evaluation: ROC metrics*.  
https://scikit-learn.org/stable/modules/model_evaluation.html#roc-metrics  

Scikit-learn. (n.d.). *Logistic regression*.  
...
Sharma, R., & Kumar, S. (2024).  
*Clinical risk factors and predictive models for heart disease*.  
PubMed Central.  
https://pmc.ncbi.nlm.nih.gov/articles/PMC12614364/  

Kumar, A., & Patel, D. (2022).  
...
*Scientific Reports*.  
https://www.nature.com/articles/s41598-025-93675-1  
